#Crear una función generadora llamada progresion_aritmetica que genere los términos de una progresión aritmética. 
#La función debe aceptar tres argumentos:
...
def progresion_aritmetica(inicio:float, paso:float,limite:float | None=10000):
    n=0
    if limite is None:
        limite=1000.0
    while inicio< limite:
